...
# build
./build.sh --clean
./build.sh --skip-keras-test --skip_tests --config "Release" --parallel 8 --enable_pybind --build_wheel --wheel_name_suffix=-silicon-rigo --osx_arch "arm64" --apple_deploy_target 11 --use_coreml
